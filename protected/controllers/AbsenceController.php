...
class AbsenceController extends Controller
{
	...
	public function actionEditable() {
		...
		if (isset($_POST['pk'])) {
	        ...
	        elseif ($_POST['name']=='AbsentOn')
	        	$model->AbsentOn = $_POST['value'];
	        elseif ($_POST['name']=='AbsentTill')
	        	$model->AbsentTill = $_POST['value'];
	...
	{
		$model=new Absence('search');
		$model->unsetAttributes();  // clear any default values
		if (isset($_GET['Absence'])) {
			$model->attributes=$_GET['Absence'];
		}
	 ...
	 * @param Absence $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if (isset($_POST['ajax']) && $_POST['ajax']==='absence-form') {
