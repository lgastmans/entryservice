...
class ETcPdf 
{
	public $pdf_creator = 'Aureka';
	public $pdf_author = 'Aureka';
	
	public $header_title = 'Aureka';
	public $header_string = 'Aspiration, Auroville, Kottakuppam 605101, Tamil Nadu';
	public $header_margin = 2;
	
	public $pdf_title = 'Customer Invoice';
	
	public $margin_top = 1;
	public $margin_left = 1;
	public $margin_right = 1;
	public $margin_bottom = 1;
